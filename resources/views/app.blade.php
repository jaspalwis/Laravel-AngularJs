...
<html lang="en" data-ng-app="MetronicApp">
	...
	<![endif]-->
		...
		<!-- Pagination -->
        <script src="{{ asset('/assets/global/plugins/angularjs/dirPagination.js') }}" type="text/javascript"></script>
        <!-- END CORE ANGULARJS PLUGINS -->
        <!-- BEGIN APP LEVEL ANGULARJS SCRIPTS -->
        <script src="{{ asset('/assets/js/main.js') }}" type="text/javascript"></script>
        <script src="{{ asset('/assets/js/directives.js') }}" type="text/javascript"></script>
